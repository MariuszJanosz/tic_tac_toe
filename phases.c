...
static Phase_t init_start_menu_phase() {
	...
	res.buttons = buttons;
	res.button_count = 3;
	init_button(&buttons[0], START_MENU_HUMAN_VS_AI_BUTTON, 50.0, 50.0, 100.0, 50.0);
	init_button(&buttons[1], START_MENU_HUMAN_VS_HUMAN_BUTTON, 50.0, 150.0, 100.0, 50.0);
	init_button(&buttons[2], START_MENU_QUIT_BUTTON, 50.0, 250.0, 100.0, 50.0);
	return res;
}
...
static Phase_t init_ai_difficulty_menu_phase() {
	...
	res.buttons = buttons;
	res.button_count = 3;
	init_button(&buttons[0], AI_DIFFICULTY_MENU_EASY_BUTTON, 50.0, 50.0, 100.0, 50.0);
	init_button(&buttons[1], AI_DIFFICULTY_MENU_HARD_BUTTON, 50.0, 150.0, 100.0, 50.0);
	init_button(&buttons[2], AI_DIFFICULTY_MENU_PERFECT_BUTTON, 50.0, 250.0, 100.0, 50.0);
	return res;
}
...
static Phase_t init_game_over_menu_phase() {
	...
	res.buttons = buttons;
	res.button_count = 2;
	init_button(&buttons[0], GAME_OVER_MENU_PLAY_AGAIN_BUTTON, 50.0, 50.0, 100.0, 50.0);
	init_button(&buttons[1], GAME_OVER_MENU_QUIT_BUTTON, 50.0, 150.0, 100.0, 50.0);
	return res;
}
